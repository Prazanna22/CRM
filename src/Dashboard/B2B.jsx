...
export const B2B = () => {
    ...
    //     try {
    //         const response = await fetch("https://b314-49-204-115-127.ngrok-free.app/food_APP/export_b2b/", {
    //             method: "GET",
    //             headers: {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("https://b314-49-204-115-127.ngrok-free.app/food_APP/get_b2b/", {
                    method: "GET",
                    headers: {
