...
export const OutsourceDB = () => {
    ...
    const startCall = async () => {
        try {
            const response = await fetch("https://b314-49-204-115-127.ngrok-free.app/food_APP/call-ai-agent/", {
                method: "GET",
                headers: {
    ...
    const stopCall = async () => {
        try {
            const response = await fetch("https://b314-49-204-115-127.ngrok-free.app/food_APP/stop-call/", {
                method: "POST",
                headers: {
                    "ngrok-skip-browser-warning": "true"
                }
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("https://b314-49-204-115-127.ngrok-free.app/food_APP/outsource/", {
